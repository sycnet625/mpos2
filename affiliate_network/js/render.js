    ...
    ns.renderAdmin = function () {
        ...
        if (state.adminTab === 'dashboard') {
            ...
            body = '<div class="grid kpis">'
                ...
                }).join('') : '<div class="item"><div class="sub">Sin salida registrada.</div></div>') + '</div></div></div><div class="card" style="margin-top:18px"><div class="item-title">Journal reciente del servicio</div><div class="list" style="margin-top:12px">' + (healthJournal.length ? healthJournal.map(function (line) {
                    return '<div class="item"><div class="sub" style="white-space:pre-wrap">' + ns.esc(line) + '</div></div>';
                }).join('') : '<div class="item"><div class="sub">Sin journal disponible.</div></div>') + '</div></div><div class="grid two"><div class="card"><div class="item-title">Top productos por interes</div><div class="list" style="margin-top:12px">' + topProducts.map(function (p, i) {
