...
(function (ns) {
    ...
    ns.renderAdmin = function () {
        ...
        if (state.adminTab === 'dashboard') {
            ...
            body = '<div class="grid two"><div class="card"><div class="section-title"><h3>Dueños registrados</h3><button class="btn primary" data-open-owner-new>+ Dueño</button></div><div class="list" style="margin-top:12px">' + (state.ownerAdminList || []).map(function (owner) {
