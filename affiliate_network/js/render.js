    ...
    ns.renderAdmin = function () {
        ...
        if (state.adminTab === 'dashboard') {
            ...
            body = '<div class="grid kpis">'
                ...
                + '</div><div class="actions" style="margin:12px 0 18px"><a class="btn ghost" href="/affiliate_network_api.php?action=export_users">⬇️ Exportar usuarios CSV</a><a class="btn ghost" href="/affiliate_network_api.php?action=export_access_audit">⬇️ Exportar accesos CSV</a></div><div class="grid two"><div class="card"><div class="section-title"><h3>Dueños registrados</h3><button class="btn primary" data-open-owner-new>+ Dueño</button></div><div class="list" style="margin-top:12px">' + (state.ownerAdminList || []).map(function (owner) {
