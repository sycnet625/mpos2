...
(function (ns) {
    ...
    ns.state = {
        ...
        activeSessions: [],
        recentLockouts: [],
        webpushDeliverySummary: { total: 0, active: 0, invalid: 0, delivered: 0, okEvents: 0, failEvents: 0 },
        webpushDeliveryEvents: [],
        webpushSubscriptions: [],
        userRoleSummary: { admin: { active: 0, suspended: 0, total: 0 }, owner: { active: 0, suspended: 0, total: 0 }, gestor: { active: 0, suspended: 0, total: 0 } },
        accessAudit: [],
        ...
        health: { ok: null, timestamp: '', mode: '', exit_code: null, output: [], timer: { enabled: false, active: false, next: '', last: '' }, service: { active: false, journal: [] }, summary: { checks: 0, okChecks: 0, failedChecks: 0 } },
