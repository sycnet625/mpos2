...
<head>
  ...
  <style>
    ...
    .cta{margin-top:18px;display:grid;gap:12px}.btn{border:none;border-radius:14px;padding:14px 16px;font-weight:800;font-size:14px;cursor:pointer;text-decoration:none;display:inline-flex;align-items:center;justify-content:center}.btn.primary{background:linear-gradient(135deg,#ffd700,#ff8c00);color:#241700}.btn.ghost{background:rgba(80,70,50,.08);color:#4c402c}.field{display:grid;gap:6px}.field input{border:1px solid rgba(92,78,56,.24);border-radius:12px;padding:12px 14px;font-size:14px}.error{margin-top:14px;padding:14px;border-radius:14px;background:rgba(239,83,80,.14);color:#ffd7d7}.hero{display:grid;gap:18px}.emoji{font-size:54px}.meta{display:grid;gap:8px}
