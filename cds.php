...
<div class="welcome-screen" id="welcomeScreen">
    ...
    <div class="qr-container">
        <?php 
            ...
            $path = str_replace('cds.php', 'client_order.php', explode('?', $uri)[0]);
...
<script>
    ...
    function enableAudio() {
        ...
        // Guardar preferencia en localStorage para recordar en futuras visitas
        localStorage.setItem('customer_display_sound_enabled', 'true');
    ...
    // Verificar si el sonido ya fue activado previamente
    document.addEventListener('DOMContentLoaded', function() {
        const soundEnabled = localStorage.getItem('customer_display_sound_enabled');
        if (soundEnabled === 'true') {
            // Activar sonido automáticamente si ya fue habilitado antes
            enableAudio();
        }
    });
