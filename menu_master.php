...
$menuCategories = [
    ...
    "💬 Atención al Cliente" => [
        ...
        ["icon" => "fa-robot", "name" => "WhatsApp BOT", "url" => "pos_bot.php"],
    ...
    "🏭 Producción" => [
        ["icon" => "fa-cog", "name" => "Producción", "url" => "pos_production.php"],
        ["icon" => "fa-blender", "name" => "Importar Recetas (Excel)", "url" => "importar_recetas_palweb_ok.php"],
    ],
    "💰 Finanzas" => [
