...
$manifest = [
    ...
    'icons'            => [
        ['src' => $prefix . '/icon-shop-192.png', 'sizes' => '192x192', 'type' => 'image/png', 'purpose' => 'any'],
        ['src' => $prefix . '/icon-shop-512.png', 'sizes' => '512x512', 'type' => 'image/png', 'purpose' => 'maskable any'],
    ],
    'screenshots'      => [
        [
    ...
    'shortcuts'        => [
        [
            'name'      => 'Ver catálogo',
            'url'       => $shopScope,
            'icons'     => [['src' => $prefix . '/icon-shop-192.png', 'sizes' => '192x192']],
        ],
    ],
];
