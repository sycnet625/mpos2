    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row g-2">
          ...
          <div class="col-md-6"><label class="form-label">Estado</label><select id="editCampaignStatus" class="form-select"><option value="scheduled">scheduled</option><option value="queued">queued</option><option value="error">error</option></select></div>
