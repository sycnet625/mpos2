...
// Menú Flotante v2.9 - FIX: JS Error (Semicolon missing)
...
$menuCategories = [
    ...
    "📦 Inventario" => [
        ...
        ["icon" => "fa-boxes", "name" => "Nuevo Producto", "url" => "pos_newprod.php"],
...
<div id="palweb-float-nav">
    <div class="pw-menu-content" id="pwMenuContent">
        ...
        <?php foreach($menuCategories as $catName => $links): ?>
            <div class="pw-cat-title"><?php echo htmlspecialchars($catName); ?></div>
...
}; // <--- CORRECCIÓN DE ERROR JS: PUNTO Y COMA AGREGADO AQUÍ
